...
?>
            ...
            <div class="container seopage-tmpl">
                <section class="maincontent-starpages maincontent-landingpages" id="parent-incontent-starpages">
                    ...
                    <ul class="startpages-list">
                        ...
                        <li class="startpages-list__item"><a href="/lte/landing" class="startpages-link active-startpages-link">LANDINGPAGES</a></li>
                        <li class="startpages-list__item"><a href="/lte/legal" class="startpages-link">LEGALS</a></li>
                    </ul>
                    <div class="current-choice">
                        <span class="selected">LANDINGPAGES</span>
                    ...
                    <?php if($visable_form){?>
                        ...
                        <?= $form->field($model, 'real_action')->hiddenInput(['value' => 'site/custom'])->label(false) ?>
                    ...
                    <?php foreach ($pages  as $page): ?>
                        <section class="landingpages-items-section">
                            <div class="landingpages-items">
                                <a href="/lte/landing?id=<?= $page->id ?> " class="landingpages-items__num"><?php echo $page->identifier?></a>
    ...
    <!--        </div>-->
    <!--    </div>-->
<?php $this->registerJsFile('/templates/C81/js/app.js'); ?>