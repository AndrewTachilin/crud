...
<body>
        ...
        <div class="container seopage-tmpl">
            <section class="maincontent-starpages maincontent-landingpages" id="parent-incontent-starpages">
                ...
                <ul class="startpages-list">
                    <li class="startpages-list__item"><a href="/lte/content" class="startpages-link active-startpages-link">HOMEPAGES</a></li>
                ...
                <div class="current-choice">
                    <span class="selected">HOMEPAGES</span>
    ...
    <!--                    <a href="/lte/landing" class="button-simple button-create-new">create new</a>-->
                ...
                <?php endif; ?>
                    <a href="/lte/content" class="button-simple change-url" style="display: none">create new</a>
                </div>
                <?php if($visable_form){?>
                    ...
                    <!-- <= $form->field($model, 'description')->textInput(['value' => !empty($data->description)? $data->description: 'this field is default','class'=> 'form-control reset-form-class base-textarea page-description','id' => 'startpages-description'])->label(false) ?> -->
                    ...
                    <!-- <= $form->field($model, 'text')->textInput(['value' => !empty($data->text)? $data->text: 'this field is default','class'=> 'form-control reset-form-class base-textarea text-homepage','id' => 'startpages-text'])->label(false) ?> -->
                    ...
                    <?= $form->field($model, 'real_action')->hiddenInput(['value' => 'site/index'])->label(false) ?>
                    ...
                    <?php foreach ($pages  as $page): ?>
                        <section class="landingpages-items-section">
                            <div class="landingpages-items">
                                <a href="/lte/content?id=<?= $page->id ?> " class="landingpages-items__num"><?php echo $page->identifier?></a>
...
<!--        </div>-->
<!--    </div>-->
<?php $this->registerJsFile('/templates/C31/js/app.js'); ?>